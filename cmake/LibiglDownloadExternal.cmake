...
function (SparseGitCheckout checkout_dir url branch)
	if(EXISTS ${checkout_dir})
		file(REMOVE_RECURSE ${checkout_dir})
	endif()
	file(MAKE_DIRECTORY ${checkout_dir})
	set(cmds "git init")
	set(cmds ${cmds} "git remote add -f origin --no-tags -t main ${url}")
	...
	foreach(cmd ${cmds})
		...
		if(pull IN_LIST cmdList)
			string (REPLACE ";" "\n" FILES "${ARGN}")
			file(WRITE ${checkout_dir}/.git/info/sparse-checkout ${FILES} )
		endif()
		execute_process(
				COMMAND ${cmdList}
				OUTPUT_QUIET
...
## IGL Core
function(igl_download_core)
	if (NOT EXISTS ${LIBIGL_EXTERNAL}/igl)
		message(STATUS "Downloading igl")
		SparseGitCheckout(${LIBIGL_EXTERNAL}/igl_temp https://github.com/libigl/libigl.git v2.4.0 include/igl)
		file(RENAME ${LIBIGL_EXTERNAL}/igl_temp/include/igl ${LIBIGL_EXTERNAL}/igl)
		file(REMOVE_RECURSE ${LIBIGL_EXTERNAL}/igl_temp)
	endif()
endfunction()

## CGAL
#function(igl_download_cgal)
#	if (NOT EXISTS ${LIBIGL_EXTERNAL}/cgal)
...
#	if (NOT EXISTS ${LIBIGL_EXTERNAL}/comiso)
#		message(STATUS "-- Downloading comiso")
...
#	if (NOT EXISTS ${LIBIGL_EXTERNAL}/cork)
#		message(STATUS "-- Downloading cork")
...
function(igl_download_eigen)
	if (NOT EXISTS ${LIBIGL_EXTERNAL}/eigen)
...
function(igl_download_glfw)
	if (NOT EXISTS ${LIBIGL_EXTERNAL}/glfw)
...
function(igl_download_imgui)
	if (NOT EXISTS ${LIBIGL_EXTERNAL}/imgui)
	...
	if (NOT EXISTS ${LIBIGL_EXTERNAL}/libigl-imgui)
		message(STATUS "Downloading libigl-imgui")
...
function(igl_download_imguizmo)
	if (NOT EXISTS ${LIBIGL_EXTERNAL}/imguizmo)
...
function(igl_download_stb)
	if (NOT EXISTS ${LIBIGL_EXTERNAL}/stb)
