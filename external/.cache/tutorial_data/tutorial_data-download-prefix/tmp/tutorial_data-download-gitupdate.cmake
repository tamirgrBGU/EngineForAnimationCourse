...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref 5c6a1ea809c043d71e5595775709c15325a7158c
  WORKING_DIRECTORY "C:/Dev/EngineIGLnew/cmake/../external/../tutorial/data"
...
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 5c6a1ea809c043d71e5595775709c15325a7158c
  WORKING_DIRECTORY "C:/Dev/EngineIGLnew/cmake/../external/../tutorial/data"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Dev/EngineIGLnew/cmake/../external/../tutorial/data/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Dev/EngineIGLnew/cmake/../external/../tutorial/data/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "C:/Program Files/Git/cmd/git.exe" checkout 5c6a1ea809c043d71e5595775709c15325a7158c
      WORKING_DIRECTORY "C:/Dev/EngineIGLnew/cmake/../external/../tutorial/data"
      RESULT_VARIABLE error_code
      )
    if(error_code)
