...
execute_process(
  COMMAND ${CMAKE_COMMAND} -E remove_directory "C:/Dev/EngineForAnimationCourse/cmake/../external/glfw"
...
while(error_code AND number_of_tries LESS 3)
  execute_process(
    COMMAND "C:/Program Files/Git/cmd/git.exe" -c http.sslVerify=false clone --config advice.detachedHead=false "https://github.com/glfw/glfw.git" "glfw"
