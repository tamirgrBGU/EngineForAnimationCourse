...
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 cd0fa3fcd90325c83be4d697b00214e029f94ca3
  WORKING_DIRECTORY "C:/Dev/EngineForAnimationCourse/cmake/../external/stb"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    execute_process(
      COMMAND "C:/Program Files/Git/cmd/git.exe" checkout cd0fa3fcd90325c83be4d697b00214e029f94ca3
      WORKING_DIRECTORY "C:/Dev/EngineForAnimationCourse/cmake/../external/stb"
      RESULT_VARIABLE error_code
      )
    if(error_code)
