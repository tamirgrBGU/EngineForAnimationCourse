...
// std::string - STD std::string Library
#include <string>
...
// Split a std::string into a std::string array at a given token
...
// Get tail of std::string after first token and possibly following spaces
...
// Description: The OBJ Model Loader
    ...
    public:
        ...
        // Tal: this variant added so we can pass std::istringstream instead of ifstream
        ...
        bool LoadFile(std::istream &file, const std::string& Path = "")
        {
            LoadedMeshes.clear();
